...
class Mashroom:
    ...
    def can_i_eat_this(self) -> str:
        ...
        Пример:
        >>> unknown_mashroom = Mashroom('Опёнок (вроде)')
        >>> print(unknown_mashroom.can_i_eat_this())
        """
        ...
        return "На свой страх и риск..."
...
class FlyAgaric(Mashroom):
    ...
    def can_i_eat_this(self) -> str:
        ...
        Пример:
        >>> fly_agaric = FlyAgaric('Мухомор', 26)
        >>> print(fly_agaric.can_i_eat_this())
        """
        ...
        return "Мухомор - ядовитый гриб"
...
if __name__ == "__main__":
    ...
    print(mashroom)
    print(repr(mashroom))
    print(mashroom.can_i_eat_this())
    mashroom1 = FlyAgaric('похож на мухомор', 32)
    print(mashroom1)
    print(repr(mashroom1))
    print(mashroom1.can_i_eat_this())
    doctest.testmod()
